export default {
  ...
  menu: {
    ...
    g3: 'Nhập dữ liệu', g3a: 'Nhập dữ liệu AI', g3b: 'Nhập dữ liệu nhà quảng cáo', g3c: 'Chỉnh sửa dữ liệu media',
    g4: 'Truy vấn dữ liệu', g4a: 'Lợi nhuận tổng', g4b: 'Lợi nhuận đơn quảng cáo', g4c: 'Dữ liệu nhà quảng cáo', g4d: 'Dữ liệu media',
  ...
  report: {
    ...
    dailyProfit: 'Lợi nhuận theo ngày', detailRevenue: 'Thu từ nhà quảng cáo', detailCost: 'Chi cho media', hiddenMediaCost: 'Chi phí chưa phân loại',
  ...
  entry: {
    ...
    traffic: 'Dữ liệu lưu lượng', settlement: 'Dữ liệu thanh toán', receivable: 'Số tiền phải thu',
    value: 'Giá trị', confirm: 'Xác nhận dữ liệu', confirmed: 'Đã xác nhận', unconfirmed: 'Chưa xác nhận',
    online: 'Trực tuyến', offline: 'Ngoại tuyến', showOffline: 'Hiện cả liên kết ngoại tuyến',
    saveRow: 'Xác nhận', savedShort: 'Xác nhận', deleteRow: 'Xóa dữ liệu', savedRow: 'Đã lưu vào hệ thống', forDate: 'Dữ liệu ngày',
