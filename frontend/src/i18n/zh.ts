export default {
  ...
  menu: {
    ...
    g3: '数据录入', g3a: 'AI数据录入', g3b: '广告主数据录入', g3c: '媒体数据编辑',
    g4: '数据查询', g4a: '总利润', g4b: '广告订单利润', g4c: '广告主数据', g4d: '媒体数据',
  ...
  report: {
    ...
    year: '年', month: '月',
    dailyProfit: '每日利润', detailRevenue: '广告主收入', detailCost: '媒体支出', hiddenMediaCost: '未分类成本',
  ...
  entry: {
    ...
    traffic: '流量数据', settlement: '结算数据', receivable: '应收金额',
    value: '数值', confirm: '确认数据', confirmed: '已确认', unconfirmed: '未确认',
    online: '在线', offline: '离线', showOffline: '同时显示离线链接',
    saveRow: '确认', savedShort: '确认', deleteRow: '删除数据', savedRow: '已保存到系统', forDate: '数据日期',
